...
def display_func():
    ...
    message = Message(display_win, text='\n\nYour transaction has been successful\n\nThank you for using our', font=cour20, fg=' sky blue')
    message.pack()
...
def withdrawal_func():
    ...
    enter_btn = Button(bf, text='ENTER', font=cour15, fg='green', bg='sky blue', command=question_func)
    enter_btn.pack(side=LEFT, pady=10)
    

    clear_btn = Button(bf, text='CLEAR', font=cour15, fg='orange', bg='sky blue', command=lambda: money_entry.delete(1))
...
def change_pin_func():
    ...
    enter_btn = Button(bf, text='ENTER', font=cour15, fg='green', bg='sky blue', command=message_func )
    enter_btn.pack(side=LEFT, pady=10)

    clear_btn = Button(bf, text='CLEAR', font=cour15, fg='orange', bg='sky blue', command=lambda: [pin_entry.delete(0), re_entry.delete(0)])
    clear_btn.pack(side=LEFT, padx=10)
...
def enter_pin():
    ...
    enter_btn = Button(bf0, text='ENTER', font=cour15,fg='green', bg='sky blue', command=option_func)
    enter_btn.pack(side= LEFT, pady=10,padx=10)

    exit_btn = Button(bf0, text='EXIT', font=cour15, fg='red', bg='sky blue', command=lambda:[enter_pin.new_win.destroy(), win.deiconify()])   # .deiconify() makes the associated window visible
    exit_btn.pack(side=RIGHT, padx=10)

    clear_btn = Button(bf0,text='CLEAR', font=cour15, fg='orange', bg='sky blue', command=text_delete)
